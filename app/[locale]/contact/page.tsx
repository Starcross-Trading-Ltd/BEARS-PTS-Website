...
export default function ContactPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-16">
      <h1 className="text-4xl font-bold text-primary mb-8">{t("contactUsTitle")}</h1>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        <div>
          <h2 className="text-2xl font-semibold mb-6">{t("getInTouchTitle")}</h2>
          <p className="text-gray-700 mb-8">{t("getInTouchDescription")}</p>
        ...
        <div>
          <h2 className="text-2xl font-semibold mb-6">{t("sendMessageTitle")}</h2>
