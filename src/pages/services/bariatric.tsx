    ...
    <div className="min-h-screen">
      ...
      <section className="bg-[#0a2240] text-white py-12">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl font-bold">{t("services.bariatric.title", "Bariatric Service")}</h1>
        </div>
      </section>
              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">{t("serviceDetails.comfortDescription", "We understand the importance of comfort during medical transport. Our vehicles are designed to prevent discomfort and maintain the patient's well-being during transport.")}</p>
                  </div>
                  <div>
          ...
          <div className="lg:col-span-1">
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><a href="/services/critical-retrieval" className="text-[#4285f4] hover:underline">{t("services.criticalRetrieval.title", "Critical Care Retrieval")}</a></li>
