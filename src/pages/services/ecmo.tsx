          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-2xl shadow-xl p-8">
              ...
              <div className="space-y-8">
                <div>
                  <h2 className="text-2xl font-bold text-primary mb-4">{t("services.ecmo.whatIsTitle", "What is ECMO?")}</h2>
                ...
                <div>
                  <h2 className="text-2xl font-bold text-primary mb-4">{t("services.ecmo.ourServiceTitle", "Our Specialised ECMO Service")}</h2>
                  <p className="text-gray-700 mb-4">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-primary mb-4">{t("services.ecmo.equipmentTitle", "Advanced Equipment and Vehicles")}</h2>
                  <p className="text-gray-700 mb-4">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-primary mb-4">{t("services.ecmo.availabilityTitle", "24/7 Availability")}</h2>
                  <p className="text-gray-700 mb-4">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-primary mb-4">{t("services.ecmo.personalisedCareTitle", "Personalised Care and Support")}</h2>
                  <p className="text-gray-700 mb-4">
