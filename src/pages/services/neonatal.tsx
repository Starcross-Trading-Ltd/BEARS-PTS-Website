          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              <h1 className="text-4xl md:text-5xl font-bold text-[#0a2240] mb-6">
                {t("neonatal.title", "Neonatal and Paediatric intensive care transfer service")}
              </h1>
              <p className="text-lg text-gray-700 mb-8">
                {t("neonatal.intro", "At BEARS we recognise the critical nature of neonatal transportation, for newborn and paediatric patients requiring urgent care and specialised support.")}
              </p>
            ...
            <aside className="lg:col-span-1">
              <div className="bg-white p-6 rounded-lg shadow-lg mb-8">
                <img 
                  ...
                  alt={t("neonatal.sideImageAlt", "Neonatal Transport")}
